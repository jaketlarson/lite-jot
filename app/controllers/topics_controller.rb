class TopicsController < ApplicationController
  ...
  def create
    ...
    if topic.save
      # Share with all users shared with folder where FolderShare.is_all_topics is true.
      TopicShare.share_new_topic_with_applicable_users(folder_id, topic.id, current_user)
